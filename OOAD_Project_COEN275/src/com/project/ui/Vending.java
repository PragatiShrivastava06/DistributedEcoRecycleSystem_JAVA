...
public class Vending extends JFrame implements ActionListener{
    ...
    private class DisplayPricesActionListener implements ActionListener{
        final JTextField priceField;	// price displayed here
        final JButton[] reitemImages;	// button objects can be clicked
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i=0; i<itemNames.length; i++){	
                /*Check which button was clicked and display appropriate price*/
